  ...
  return (
    <>
      ...
      <div className="socials">
        <a href="https://twitter.com/YOUR_HANDLE" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Twitter / X">
        ...
        <a href="https://discord.gg/YOUR_INVITE" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Discord">
          <svg viewBox="0 0 24 24" fill="currentColor" width="30" height="30">
